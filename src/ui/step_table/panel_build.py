...
def setup_ui(panel):
    ...
    panel.drag_hint_label.setStyleSheet("color:#6B7280; font-size:11px;")
    group_layout.addWidget(panel.drag_hint_label)

    panel.stage_context_label = QLabel("")
    panel.stage_context_label.setWordWrap(True)
    panel.stage_context_label.setStyleSheet("color:#6B7280; font-size:11px;")
    ...
    panel.hint_label.setStyleSheet("color:#6B7280; font-size:11px;")
    ...
    panel.table.setSelectionMode(QTableWidget.SingleSelection)
